<?php
/**
* Esta classe ï¿½ a responsï¿½vel pela conexï¿½o com o banco de dados.
* @author Rene F. Gabriel Junior <rene@sisdoc.com.br>
* @version 0.14.04
* @copyright Copyright ï¿½ 2011, Rene F. Gabriel Junior.
* @access public
* @package Include
...
* Esta funcao esta vinculada a biblioteca sisdoc_row.php
*/
////////////////////////////////////////
...
function redirecina($pg,$time=0)
	{
	if (round($time) > 0)
		{
			echo '<META HTTP-EQUIV=Refresh CONTENT="'.$time.'; URL='.$pg.'">';
		} else {
			header("Location: ".$pg);
			echo 'Stoped'; exit;		
		}
