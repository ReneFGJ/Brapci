...
array_push($mnpos,array('país','brapci_ajax_pais.php'));
////////////////////////////
...
$cdf = array('id_'.$idcp,$idcp.'_nome',$idcp.'_sigla2',$idcp.'_sigla3',$idcp.'_codigo');
$cdm = array('Código','Nome','Sigla 2','Sigla 3','código');
$masc = array('','','','','','','','','','','');
$busca = true;
$offset = 20;
