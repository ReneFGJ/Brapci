...
array_push($cp,array('$O N:NC&T:Termo Indexador&D:Data&G:Geográfico&A:Autoridade&W:Não usado','kw_tipo','Tipo',False,True,''));
...
array_push($cp,array('$O 0:Visível&1:Oculto','kw_hidden','Descritor',False,True,''));
