...
array_push($menu,array(msg('DIR!S'),'Diretório de pesquisadores (pós-graduação)','diris_authors_pos.php'));
...
array_push($menu,array(msg('cadastro'),msg('journals'),'journals.php'));
array_push($menu,array(msg('cadastro'),msg('secoes'),'sections.php'));
array_push($menu,array(msg('cadastro'),msg('site_page'),'ic.php'));

array_push($menu,array(msg('public_module'),msg('export_to_public'),'export_public.php'));
