...
// Versão atual           //    data     //
//---------------------------------------//
// 1.0o                       01/11/2011 // Instalado funcição QA
// 1.0n                       14/07/2011 // Estado de RO
...
<script type="text/javascript">
    function exibeModeloSelect(id_marca,cps,para) {
    $.ajax(
    {
    type: "POST", url: "_ajax_sisdoc_select.php", data: "acao=exibeModeloSelect&filtro=" + id_marca+"&para="+para,
    beforeSend: function() { }, success: function(txt) { $(cps).html(txt); },
    error: function(txt) { } } );
    }
</script>
...
//************************************************* SQL
	if (substr($c3,1,2) == "QA" )
		...
		$gets = $gets . '<select id="'.$c1.'" name="'.$c1.'" size="1">';
