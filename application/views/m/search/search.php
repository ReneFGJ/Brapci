...
<div class="container-fluid search">
	<form method="post" id="form_search" action="<?php echo base_url('index.php/m/'); ?>">
	    <div class="col-xs-12">
            </br>	        
	    </div>
		...
		<div class="row">
			<div class="col-xs-10 col-xs-offset-1">
				<div class="input-group" style="padding: 5px; ">
					...
					<input type="text" class="form-control selector" <?php echo $style_dd4f; ?> name="dd4f" id="dd4f" placeholder="Busca nas referências..." value="<?php echo get("dd4f"); ?>" />
		...
		<!---- Type ---->
		<div class="row">
			<div class="col-md-7 col-xs-7 col-xs-offset-2 col-md-offset-2" style="color: #ffffff;">
				...
				Resumo
				<div class="visible-xs visible-sm"></div>
				<input type="radio" name="dd3" value="5" id="dd3_5" <?php echo $check_dd3[5]; ?> >
				Referências
				<div class="visible-xs visible-sm"></div>
				<br>
			</div>
