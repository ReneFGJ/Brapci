<div class="menu">
	...
	<div class="menu_01">
		<A HREF="<?php echo base_url('index.php/home/selection/'.$_SESSION['bp_session']); ?>" class="link_menu" id="basket"> <img src="<?php echo base_url('img/icone_my_library.png'); ?>" border=0 height="20" >&nbsp;
		-
	</div>
	<div class="menu_01">
