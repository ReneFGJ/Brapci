...
<table width="100%" border=0 >
	...
	<div id="login_form">
		...
		echo form_submit($data);
			...
			<table width="200" class="border1" align="center" class="tabela00">
				<tr><td class="lt1" style="padding: 10px;"><?php echo msg('login_social'); ?></td></tr>
				<tr><td style="padding: 10px;"><a href="<?php echo base_url('index.php/social/session/facebook/'); ?>"><button class="btn btn-facebook"><i class="fa fa-facebook"></i> | Login com o Facebook</button></A></td></tr>
				<tr><td style="padding: 10px;"><a href="<?php echo base_url('index.php/social/session/google/'); ?>"><button class="btn btn-google-plus"><i class="fa fa-google-plus"></i> | Login com o Google+</button></A></td></tr>
			</table>					
