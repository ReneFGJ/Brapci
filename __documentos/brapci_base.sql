...
--
-- Host: localhost
-- Generation Time: Mar 18, 2016 at 10:03 AM
...
--
ALTER TABLE `wese_concept`
MODIFY `id_c` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=143;
--
...
--
ALTER TABLE `wese_label`
MODIFY `id_l` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=254;
--
...
--
ALTER TABLE `wese_note`
MODIFY `id_wn` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `wese_term`
MODIFY `id_t` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=285;
