    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jnl_ano_inicio', models.CharField(max_length=5, verbose_name='Início da publicação')),
                ('jnl_ano_final', models.CharField(max_length=5, verbose_name='Fim da publicação')),
